...
export default function InformationBar() {
  return (
    <div className="flex w-full justify-center items-center">
      <div className="bg-[#f49cbbd3] text-dark text-sm flex flex-wrap w-11/12 rounded-xl p-2 lg:flex-nowrap lg:justify-center">
        <div className="flex items-center justify-start  gap-2 p-1 w-1/2 lg:justify-center lg:w-auto lg:px-10 ">
          <Image
